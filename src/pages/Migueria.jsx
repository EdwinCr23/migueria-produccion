...
const Migueria = () => {
    return (
        <div>
            <Header />
            <h1>Bienvenid@</h1>
            <div className="cursos" style={{
                display: 'flex',
                justifyContent: 'center'
            }}>
                <div className="cumpleanios" style={{
                    padding: 10
                }}>
                    <Card sx={{
                        width: 200,
                        ...
                        <CardContent>
                            ...
                            <Typography variant="body2" sx={{
                                ...
                                fontSize: '12px'
                            }}>Registra la fecha de cumpleaños de los colaboradores</Typography>
                        </CardContent>
                        <CardActions>
                        ...
                        <CardContent>
                            ...
                            <Typography variant="body2"
                                sx={{
                                    ...
                                    fontFamily: 'Archer-Book-Pro',
                                    fontSize: '12px'
                                }}>Separa la sala de juntas para tus reuniones</Typography>
                        </CardContent>
                        <CardActions>
                            <Button size="small" sx={{
                                width: '90%',
