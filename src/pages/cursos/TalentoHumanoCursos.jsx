                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    style={{
                                        ...
                                        color: '#54351a',
                                        fontFamily: 'Hagins-Caps'
                                    }} to="https://elmiguerito.com/escuela/course/view.php?id=18"
                        ...
                        <CardContent>
                            <Typography gutterBottom component="h5"
                                sx={{
                                    ...
                                    color: '#54351a',
                                    fontFamily: 'Hagins-Caps'
                                }}>Plan de crecimiento</Typography>
                        </CardContent>
                        <CardActions>
                            <Button
                                size="small"
                                sx={{
                                    ...
                                    style={{
                                        ...
                                        color: '#54351a',
                                        fontFamily: 'Hagins-Caps'
                                    }} to="https://elmiguerito.com/escuela/course/view.php?id=19"
                                    target='blank'>Realizar</Link></Button>
                        </CardActions>
                    </Card>
                </div>
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    style={{
                                        ...
                                        color: '#54351a',
                                        fontFamily: 'Hagins-Caps'
                                    }} to="https://elmiguerito.com/escuela/course/view.php?id=20"
                                    target='blank'>Realizar</Link></Button>
                        </CardActions>
                    </Card>
                </div>
